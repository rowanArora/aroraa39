...
def multiply_with_loops(matrix1, matrix2):
    ...
    """
    # First get all of the lengths and assign them to variables.
    n = len(matrix1)
    m = len(matrix1[0])
    k = len(matrix2[0])

    # Next, we will make our output array and make it of size N x K
...
if __name__ == "__main__":
    ...
    matrix1 = np.random.randint(low=0, high=None, size=(n, m))
    matrix2 = np.random.randint(low=0, high=None, size=(m, k))
