...
if __name__ == "__main__":
    ...
    print("The best classifier was the", decision_tree_model, "with an accuracy of", accuracy, "percent.")

    # Test for Part C
    print("The maximum accuracy on validation sets: {}".format(accuracy))
    print("-----\n The best tree is based on: {} and gets this accuracy on the training set:".format(decision_tree_model.get_params()['criterion']))
    measure_model_accuracy(decision_tree_model, learning_data['X_test'], learning_data['y_test'])
    
    # dot_data = tree.export_graphviz(decision_tree_model,feature_names=feature_names, filled=True, class_names=['Fake', 'Real'], max_depth=2)
